    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: theme.colors.primary, marginBottom: '24px' }}>
            Glass Components
          </h2>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ color: theme.colors.text, marginBottom: '12px' }}>
              First Layer
            </h3>
            <div style={{
              ...glassStyle,
              ...
              <p style={{ color: theme.colors.textTertiary, fontSize: '14px' }}>
                Multiple glass layers create depth and hierarchy while maintaining transparency throughout the design.
              </p>
            </div>
          </div>
        </div>
